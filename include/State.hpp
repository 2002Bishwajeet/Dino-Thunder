...
public:
    ...
    //  All the functions need to be declared as virtual since we are inheriting
    //  from this class This is a pure virtual function Also we need to declare
    //  the destructor as virtual since we are inheriting from this class Not
    //  declaring it would not lead to proper dispose of this class
    ...
    //  This function will be called every deltaTime(which takes as a parameter)
    //  to update the game state like reposition or colors etc
